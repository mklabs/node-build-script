(function() {
  ...
  //
  // We don't use jQuery for this, but one could totally change this
  // (could we? todo: a way to overidde this file). It should work well
  // on every (non crappy) browsers. (eg. should implement
  // querySelector).
  //
